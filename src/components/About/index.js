    ...
    <div className="about-container">
      <section className="aboutHeader my-5" >
        ...
        <div className="my-2">
          <h2>Welcome!</h2>
          <p>
            I am a Full stack web developer with graphic design experience, leveraging a finance/accounting background. A recent graduate of University of Toronto coding bootcamp, with newly developed skills in JavaScript, HTML, CSS, MERN: MongoDB Express.js React Node.js to name a few.
            <br />
